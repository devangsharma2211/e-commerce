            ...
            <form action="" method="post">
                <div class="input-group">
                    ...
                    <i class="fa-solid fa-user"></i>
                        <input type="text" placeholder="Username" name="username" id="username" autocomplete="off" required="required" >
                    </div>
    ...
    if($result) {
        ...
        if($rows_count > 0){
            ...
            if(password_verify($password, $row_data['password'])){
                ...
                echo "<script>window.open('./admin-area/home.php','_self')</script>";
            } else {
